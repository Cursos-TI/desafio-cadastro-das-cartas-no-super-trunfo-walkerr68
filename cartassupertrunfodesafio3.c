...
printf("População Rio de Janeiro x São Paulo : %d\n", populacao2 > populacao);
printf("Área Rio de Janeiro x São Paulo : %d\n", area2 > area);
printf("PIB Rio de Janeiro x São Paulo : %d\n", pib2 > pib);
printf("Pontos Turisticos Rio de Janeiro  x São Paulo : %d\n", pontosturisticos2 > pontosturisticos );
printf("Densidade Populacional Rio de Janeiro x São Paulo : %d\n" , DENSIPOP2 > DENSIPOP1);
printf("PBI Per Capita Rio de Janeiro x são paulo %d\n", PIBPER2 > PIBPER1);
printf("Super Poder Rio de janeiro x São Paulo %d\n", superpoder2 > superpoder);
